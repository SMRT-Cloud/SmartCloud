                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SmartCloud Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SmartCloud address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and smartcloud: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SmartCloud Core"), this);
    aboutAction->setStatusTip(tr("Show information about SmartCloud Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SmartCloud"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SmartCloud addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SmartCloud addresses"));
    ...
    openAction->setStatusTip(tr("Open a SmartCloud: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SmartCloud Core help message to get a list with possible SmartCloud command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SmartCloud Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SmartCloud network", "", count));
}
...
{
    QString strTitle = tr("SmartCloud Core"); // default title
