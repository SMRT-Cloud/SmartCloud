...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SmartCloud Core"),
     ...
     * override -datadir in the smartcloud.conf file in the default data directory
     * (to be consistent with smartcloudd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
