...
/** Utility functions used by the SmartCloud Qt UI.
 */
namespace GUIUtil
{
...
// Render SmartCloud addresses in monospace font
...
// Parse "smartcloud:" URI into recipient object, return true on successful parsing
