...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SmartCloud Core smartcloud-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  smartcloud-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded smartcloud transaction") + "\n" +
                               "  smartcloud-tx [options] -create [commands]   " + _("Create hex-encoded smartcloud transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded smartcloud transaction
