...
In order to support loading of multiple wallets in smartcloud-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is smartcloud.cpp.
...
Changes to smartcloud.cpp
----------------------
smartcloud.cpp is the entry point into smartcloud-qt, and as such, will require some minor modifications to provide hooks for
