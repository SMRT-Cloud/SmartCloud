Contributing to SmartCloud Core
============================

The SmartCloud Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SmartCloud Core project, and is not to be
confused with overall SmartCloud Network Protocol consensus changes.

Whether a pull request is merged into SmartCloud Core rests with the project merge
...
Patches that change SmartCloud consensus rules are considerably more involved than
...
Where a patch set proposes to change the SmartCloud consensus, it must have been
...
The project leader is the release manager for each SmartCloud Core release.
